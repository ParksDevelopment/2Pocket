...
KC.NO, KC.NO, KC.ESC, KC.LT(1, KC.SPC, prefer_hold=True, tap_interrupted=False, tap_time=200), KC.TAB, KC.ENT, KC.LT(2, KC.BSPC, prefer_hold=True, tap_interrupted=False, tap_time=200), KC.DEL
],
# NAV
[
